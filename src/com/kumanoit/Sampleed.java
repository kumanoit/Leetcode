...
public class Sampleed {
    public static void main(String[] args) {
        ...
        // variable.
        // assert combinations(200, 5) == 15504;

        assert combinationsOptimized(500, 0) == 1;
        ...
        assert combinationsOptimized(200, 5) == 126410606437752l;

        System.out.println(combinationsOptimized(1, 1));
        System.out.println(combinationsOptimized(500, 0));
        System.out.println(combinationsOptimized(10, 5));
        System.out.println(combinationsOptimized(6, 3));
        System.out.println(combinationsOptimized(20, 5));
        System.out.println(combinationsOptimized(200, 5));
    }
